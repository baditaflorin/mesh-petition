...
**Live → https://baditaflorin.github.io/mesh-petition/**

**Source → https://github.com/baditaflorin/mesh-petition**
...
git clone https://github.com/baditaflorin/mesh-petition
cd mesh-petition
npm install
npm run dev
```
...
- `mesh-petition:signalingUrl`
- `mesh-petition:turnTokenUrl`
- `mesh-petition:iceServers`
- `mesh-petition:room`
